...
{% include figure.html path="assets/img/christophWagner.png" title="Christoph Wagner" class="img-fluid rounded z-depth-1" width=50%}
...
![text]("assets/img/christophWagner.png"){ width=60%,height:30px }
